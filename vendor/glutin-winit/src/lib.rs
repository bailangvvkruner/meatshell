...
fn create_display(
    ...
    let _preference = match _api_preference {
        ...
        // MeatShell ships ANGLE for its lower D3D11 memory baseline. Keep WGL
        // as the automatic fallback for unpackaged development builds and
        // machines where ANGLE cannot initialize.
        ApiPreference::FallbackEgl => DisplayApiPreference::EglThenWgl(_raw_window_handle),
    };
